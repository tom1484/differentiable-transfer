...
class Critic(nn.Module):
    ...
    def train_critic(
        ...
        net_out = self.forward(input_env, input_goal, input_action, input_state, input_history)
    ...
    def predict(self, input_env, input_state, input_goal, input_action, input_history):
        with torch.no_grad():
            return self.forward(input_env, input_goal, input_action, input_state, input_history)
    ...
    def action_gradients(self, input_env, input_state, input_goal, input_action, input_history):
        ...
        # Forward pass
        q_values = self.forward(input_env, input_goal, input_action, input_state, input_history)
